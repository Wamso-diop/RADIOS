...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(default='produits/images/default.jpg', upload_to='produits/images/', verbose_name='Image')),
            ],
        ),
        ...
        migrations.AddField(
            model_name='produit',
            name='images',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='boutique.images', verbose_name='images'),
            preserve_default=False,
        ),
        migrations.CreateModel(
            name='Panier',
